        ...
        <div className="flex items-center gap-1 ml-auto">
          ...
          >
            ...
            <div className="hidden lg:block">
              <p className="text-xs font-semibold text-gray-900 dark:text-white leading-none">Student Name</p>
              <p className="text-[10px] text-gray-500 dark:text-slate-500 mt-0.5">Premium Plan</p>
            </div>
          </div>
